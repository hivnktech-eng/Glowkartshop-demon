  ...
  return (
    ...
    >
      <div className="product-image-container">
        ...
        <div className={`quick-view-overlay ${isInCart ? 'cart-controls-visible' : ''}`}>
          {isInCart ? (
            ...
            <button className="btn-quick-view" onClick={() => addToCart(product)}>
              Add to Cart
            </button>
          )}
        </div>
      ...
      <div className="product-info">
        ...
        <div className="product-price-row">
          ...
          {isInCart && (
            <span className="product-cart-badge">In Cart · {cartItem.quantity}</span>
          )}
        </div>
      </div>
    </motion.div>
