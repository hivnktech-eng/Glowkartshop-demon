      ...
      <div className="container">
        ...
        >
          ...
          <p style={{ margin: "2rem 0 4rem", color: "#666" }}>
            Order #GK-{orderId} is being prepared for carbon-neutral shipment.{" "}
            <br />A confirmation has been sent to your digital address.
          </p>
          <div
      ...
      <div className="container">
        <div className="checkout-grid">
              ...
              <div className="form-grid">
                ...
                <div className="form-group full">
                  ...
                  <input
                    type="text"
                    className="checkout-input"
                    placeholder="123 Minimalist Way, Clarity District"
                  />
                </div>
                <div className="form-group">
              ...
              {step === 2 && (
                ...
                >
                  ...
                  >
                    {isProcessing
                      ? "Processing Securely..."
                      : `Secure Order for ₹${cartTotal.toLocaleString("en-IN")}`}
                  </button>
                </div>
              )}
            </section>
          ...
          <aside className="checkout-summary-mini">
            <h3 className="elegant-font" style={{ marginBottom: "2.5rem" }}>
              Your Selection
            </h3>
            <div
